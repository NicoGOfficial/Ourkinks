...
const settings = [
  {
    ...
    value: 'https://free.currconv.com/api/v7/convert',
    name: 'API endpoint',
    description: 'API endpoint for currency converstion. Check more info about server here https://www.currencyconverterapi.com/docs',
    public: false,
    autoload: false,
  ...
  },
  {
    ...
    value: 'USD',
    name: 'Base currency',
    description: 'Enter base currency code in your system, eg USD, EUR. User currency will be convert based on this value.',
    public: false,
    autoload: false,
    group: 'currencyConversion',
    editable: true
