...
export class GalleryService {
  ...
  public async details(id: string, user: UserDto) {
    ...
    const isLiked = user ? await this.reactionService.checkExisting(dto._id, user._id, REACTION.LIKE, OBJECT_TYPE.GALLERY) : null;
    dto.isLiked = !!isLiked;
    ...
    if (!user && !user.roles?.includes('admin') && (user && user._id.toString() !== gallery.performerId.toString())) {
