import {
  ArrowLeftOutlined, DollarOutlined, EyeOutlined,
    ...
    <Layout>
      ...
      <div className="main-container">
        ...
        <div className={style['product-card']}>
          <div className="prod-img">
            ...
            {product.type === 'physical' && !product.stock && (
              <span className="prod-stock">{t('common:outOfStock')}</span>
            )}
          ...
          <div className="prod-info">
            ...
            <div className="prod-desc">{product.description || t('common:noDescription')}</div>
          </div>
        </div>
      </div>
      ...
      <div className="main-container">
        <div className="related-items">
          ...
          {!fetching && !relatedProducts?.length && <p>{t('common:noProductWasFound')}</p>}
