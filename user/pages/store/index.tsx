...
class Products extends PureComponent<IProps, IStates> {
  ...
  render() {
    ...
    const type = [
      {
        key: '',
        text: t('common:allType')
      },
      {
        key: 'physical',
        text: t('common:physical')
      },
      {
        key: 'digital',
        text: t('common:digital')
      }
    ];

    return (
      <Layout>
        <PageTitle title={t('common:titleProducts')} />
        <div className="main-container">
          ...
          <div className="main-background">
            ...
            {!total && !requesting && <p className="text-center">{t('common:noProductWasFound')}</p>}
...
export default connect(mapStates, mapDispatch)(withTranslation(Products));
