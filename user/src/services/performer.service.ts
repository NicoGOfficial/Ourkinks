...
export class PerformerService extends APIRequest {
  ...
  getStatistical(performerId: any) {
    return this.get(`/statistics/performers/${performerId}`);
  }

  getStatsForLast12Months(performerId: any) {
    return this.get(`/statistics/performers/${performerId}/last-12months`);
  }
}
