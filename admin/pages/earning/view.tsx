          ...
          {!earning ? (
            ...
            <Card>
              <Row gutter={[16, 16]}>
                ...
                <Col span={16}>
                  {earning.type === 'referral' ? earning?.extraInfo?.buyer?.username || 'N/A' : earning.userInfo.username || 'N/A' }
                </Col>
              ...
              <Row gutter={[16, 16]}>
                ...
                <Col span={16}>
                  {earning.type === 'referral' ? earning?.extraInfo?.buyer?.username || 'N/A' : earning.performerInfo?.username || 'N/A' }
                </Col>
              </Row>
              ...
              <Row gutter={[16, 16]}>
                ...
                <Col span={16}>
                  {earning?.extraInfo?.inviter?.username || 'N/A'}
                </Col>
              </Row>
              )}
              {/* <Row gutter={[16, 16]}>
              ...
              <Row gutter={[16, 16]}>
                ...
                <Col span={16}>
                  {earning.type === 'referral' ? -100 : earning.commission * 100}
                  % / $
                  {earning.type === 'referral' ? (-1 * earning.netPrice).toFixed(2) : (earning.commission * earning.grossPrice).toFixed(2)}
                </Col>
              </Row>
              {/* <Row gutter={[16, 16]}>
                <Col span={8}>
