...
import {
  BarChartOutlined, FileAddOutlined, PictureOutlined, PlayCircleOutlined,
  VideoCameraAddOutlined
} from '@ant-design/icons';
import FeedUploadList from '@components/feed/feed-list-media';
import { SelectPerformerDropdown } from '@components/performer/common/select-performer-dropdown';
import { formatDate } from '@lib/date';
import { feedService } from '@services/index';
import {
  Button, Col,
  Form, Input, InputNumber, message, Progress,
  Row, Select, Switch, Tooltip, Upload
} from 'antd';
