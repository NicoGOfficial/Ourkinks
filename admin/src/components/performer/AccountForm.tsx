...
import {
  ...
  Form, Input, message, Row, Select, Switch
} from 'antd';
            ...
            >
              <div className={style['phone-code']}>
                <Input
                  ...
                  addonBefore={(
                    <Select style={{ minWidth: 300 }} defaultValue={performer?.phoneCode || 'US_+1'} optionFilterProp="label" showSearch onChange={(val) => this.setState({ selectedPhoneCode: val })}>
